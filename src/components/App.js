...
import { INIT_LIST, INIT_CLOCK_SETTING, INIT_CURRENT_MISSION_ID } from "../data"
...
const App = () => {
  ...
  const [currentMissionId, setCurrentMissionId] = useState(INIT_CURRENT_MISSION_ID)
  ...
  const handleFinishMission = useCallback(
    isBell => {
      ...
      if (isBell) console.log("isBell! isBell!")
    },
    [currentMissionId]
  )
